...
//!
//! THE ARCHITECT demands HONESTY.
//! 
//! This simulation includes:
//! - ACTUAL network delay (not fake zero-delay)
//! - Zig-zag movement that breaks linear prediction
//! - Real reconciliation with measurable error
//! - Snap corrections when prediction fails
...
fn main() {
    ...
    let total_ticks = config.duration_secs as u64 * 60;
    let mut last_progress = 0;

    while simulation.tick() {
        let progress = (simulation.current_tick() as u64 * 100 / total_ticks) as usize;
