...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_832: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_831: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_30661: (a: number, b: number, c: number, d: number) => void;
  readonly __wasm_bindgen_func_elem_42072: (a: number, b: number) => void;
